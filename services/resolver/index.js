...
// load balancer's parked health-check connections do not hold it open. Every
// request is bounded by the upstream timeout well inside the grace period, so
// there is nothing further to force.
