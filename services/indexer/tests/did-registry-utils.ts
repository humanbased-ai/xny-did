...
export function createDIDAttributeItemAddedEvent(
  ...
  let didAttributeItemAddedEvent =
    changetype<DIDAttributeItemAdded>(newMockEvent())
...
export function createDIDAttributeItemRevokedEvent(
  ...
  let didAttributeItemRevokedEvent =
    changetype<DIDAttributeItemRevoked>(newMockEvent())
...
export function createDIDControllerAddedEvent(
  ...
  didControllerAddedEvent.parameters.push(
    new ethereum.EventParam(
      "controller",
      ethereum.Value.fromUnsignedBigInt(controller)
    )
  )
...
export function createDIDControllerRevokedEvent(
  ...
  let didControllerRevokedEvent =
    changetype<DIDControllerRevoked>(newMockEvent())
